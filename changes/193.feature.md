Added TrotterizedTimeEvolution with state initialization, introduced reusable trotterization utilities, tightened Qutip time-evolution state validation. Expanded docs/tests for trotterization, QAOA behavior, and backends.
