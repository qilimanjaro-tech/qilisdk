...
TEST_F(ExecuteSamplingTest, NotSamplingType_None_ThrowsValueError) {
    ...
    EXPECT_THROW(sim.execute_sampling(py::none(), py::none(), py::none(), empty_solver_params()), py::value_error);
}

TEST_F(ExecuteSamplingTest, NotSamplingType_Object_ThrowsValueError) {
    py::gil_scoped_acquire gil;
    py::exec(R"(not_a_sampling = object())");
    EXPECT_THROW(sim.execute_sampling(py::globals()["not_a_sampling"], py::none(), py::none(), empty_solver_params()), py::value_error);
}
...
_zero_nshots = _ZeroNshots()
    ...
    EXPECT_THROW(sim.execute_sampling(py::globals()["_zero_nshots"], py::none(), py::none(), empty_solver_params()), py::value_error);
}
...
_neg_nshots = _NegNshots()
    ...
    EXPECT_THROW(sim.execute_sampling(py::globals()["_neg_nshots"], py::none(), py::none(), empty_solver_params()), py::value_error);
}
...
_zero_nqubits = _ZeroNqubits()
    ...
    EXPECT_THROW(sim.execute_sampling(py::globals()["_zero_nqubits"], py::none(), py::none(), empty_solver_params()), py::value_error);
}
...
_samp_empty = Sampling(circuit=_c_empty, nshots=20)
    ...
    EXPECT_NO_THROW(sim.execute_sampling(py::globals()["_samp_empty"], py::none(), py::none(), empty_solver_params()));
}
...
_samp_x = Sampling(circuit=_c_x, nshots=20)
    ...
    EXPECT_NO_THROW(sim.execute_sampling(py::globals()["_samp_x"], py::none(), py::none(), empty_solver_params()));
}
...
_init_sv = QTensor(sp.csr_matrix(np.array([[1.0+0j], [0.0]], dtype=complex)))
    ...
    EXPECT_NO_THROW(sim.execute_sampling(py::globals()["_samp_is"], py::none(), py::globals()["_init_sv"], empty_solver_params()));
}
...
_samp_mf = Sampling(circuit=_c_mf, nshots=20)
    ...
    EXPECT_NO_THROW(sim.execute_sampling(py::globals()["_samp_mf"], py::none(), py::none(), p));
}
...
_shrink_samp = _ShrinkSampling()
    ...
    EXPECT_NO_THROW(sim.execute_sampling(py::globals()["_shrink_samp"], py::none(), py::none(), empty_solver_params()));
}
...
_samp_res = Sampling(circuit=_c_res, nshots=50)
    ...
    py::object result;
    ASSERT_NO_THROW(result = sim.execute_sampling(py::globals()["_samp_res"], py::none(), py::none(), empty_solver_params()));
...
TEST_F(ExecuteTimeEvolutionTest, NotTimeEvolutionType_None_ThrowsValueError) {
    py::gil_scoped_acquire gil;
    EXPECT_THROW(sim.execute_time_evolution(py::none(), py::none(), empty_solver_params()), py::value_error);
}

TEST_F(ExecuteTimeEvolutionTest, NotTimeEvolutionType_Object_ThrowsValueError) {
    py::gil_scoped_acquire gil;
    py::exec(R"(not_a_te = object())");
    EXPECT_THROW(sim.execute_time_evolution(py::globals()["not_a_te"], py::none(), empty_solver_params()), py::value_error);
}
...
_te_std = TimeEvolution(schedule=_sched_std, observables=[Z(0)], initial_state=_rho_std)
    ...
    EXPECT_NO_THROW(sim.execute_time_evolution(py::globals()["_te_std"], py::none(), empty_solver_params()));
}
...
_te_interm = TimeEvolution(
    ...
    py::object result;
    ASSERT_NO_THROW(result = sim.execute_time_evolution(py::globals()["_te_interm"], py::none(), empty_solver_params()));
...
_te_mf = TimeEvolution(schedule=_sched_mf, observables=[], initial_state=_rho_mf)
    ...
    EXPECT_NO_THROW(sim.execute_time_evolution(py::globals()["_te_mf"], py::none(), p));
}
...
_te_mf_interm = TimeEvolution(
    ...
    py::dict p;
    p["evolution_method"] = py::str("integrate_matrix_free");
    EXPECT_NO_THROW(sim.execute_time_evolution(py::globals()["_te_mf_interm"], py::none(), p));
}
...
_nm_empty = NoiseModel()
    ...
    EXPECT_NO_THROW(sim.execute_time_evolution(py::globals()["_te_nm_empty"], py::globals()["_nm_empty"], empty_solver_params()));
}
...
_nm_nonmatch.global_perturbations["nonexistent_param_xyz"].append(_Perturbation())
    ...
    EXPECT_NO_THROW(sim.execute_time_evolution(py::globals()["_te_nm_nonmatch"], py::globals()["_nm_nonmatch"], empty_solver_params()));
}
...
_nm_match.global_perturbations["amp"].append(_ScalePert())
    ...
    EXPECT_NO_THROW(sim.execute_time_evolution(py::globals()["_te_nm_match"], py::globals()["_nm_match"], empty_solver_params()));
}
...
_te_mm_mf = _TE_MM_MF()
    ...
    py::dict p;
    p["evolution_method"] = py::str("integrate_matrix_free");
    EXPECT_THROW(sim.execute_time_evolution(py::globals()["_te_mm_mf"], py::none(), p), py::value_error);
}
...
_te_mm_std = _TE_MM_Std()
    ...
    EXPECT_THROW(sim.execute_time_evolution(py::globals()["_te_mm_std"], py::none(), empty_solver_params()), py::value_error);
}
...
_te_shape = TimeEvolution(
    ...
    py::object result;
    ASSERT_NO_THROW(result = sim.execute_time_evolution(py::globals()["_te_shape"], py::none(), empty_solver_params()));
    EXPECT_TRUE(py::hasattr(result, "final_state"));
