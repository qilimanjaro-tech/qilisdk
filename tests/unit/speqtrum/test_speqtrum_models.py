...
def test_digital_propagation_payload():
    ...
    payload = DigitalPropagationPayload(digital_propagation=digital_propagation, readout=[])
...
def test_analog_evolution_payload():
    ...
    payload = AnalogEvolutionPayload(analog_evolution=analog_evolution, readout=[])
