...
Rather than building a model from scratch, you can also construct it for certain predefined problems:
 ...
 - :func:`~qilisdk.core.model.Model.random_ising` - Constructs a random Ising model with specified parameters.
 ...
 - :func:`Model.traveling_salesman(distances, label)<qilisdk.core.model.Model.traveling_salesman>` - Constructs a traveling salesman problem for a given distance matrix.
