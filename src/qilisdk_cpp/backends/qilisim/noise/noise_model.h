...
class NoiseModelCpp {
   ...
   public:
    ...
    std::vector<std::vector<SparseMatrix>> get_relevant_kraus_operators(const std::string& gate_name, int num_controls, const std::vector<int>& gate_qubits, int nqubits) const;
