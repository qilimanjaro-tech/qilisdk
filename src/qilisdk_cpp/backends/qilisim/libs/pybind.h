...
const py::object SamplingReadoutResults = py::module_::import("qilisdk.functionals.functional_result").attr("SamplingReadoutResults");
const py::object ExpectationReadoutResults = py::module_::import("qilisdk.functionals.functional_result").attr("ExpectationReadoutResults");
const py::object StateTomographyReadoutResults = py::module_::import("qilisdk.functionals.functional_result").attr("StateTomographyReadoutResults");
