...
class Readout(Generic[S, E, T]):
    ...
    def with_sampling(self, nshots: int = 1000, expand_samples: bool = True) -> Readout[SamplingReadoutResult, E, T]:
        ...
        logger.trace("Adding sampling readout (nshots={})", nshots)
    ...
    def with_expectation(
        ...
        logger.trace("Adding expectation readout ({} observable(s), nshots={})", len(observables), nshots)
    ...
    def with_state_tomography(self, method: Literal["exact"] = "exact") -> Readout[S, E, StateTomographyReadoutResult]:
        ...
        logger.trace("Adding state-tomography readout (method={})", method)
